# Lab 6 — Review method and provenance

The review sample contains 120 errors from `data/eval/validation_predictions.csv`. It has 45 exact text/expected-label/prediction combinations. Every original feedback ID is retained.
...
- [Completed grouped worksheet](LAB6_SHORT_REVIEW.md)
- [Original submission](LAB6_SHORT_REVIEW_SUBMITTED.md), retained verbatim, including its older status heading
- [Structured grouped review](../artifacts/lab6/human_group_review.json), including source hashes and acceptance scope
